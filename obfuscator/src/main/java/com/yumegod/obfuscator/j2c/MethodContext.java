...
import com.yumegod.obfuscator.j2c.caches.*;
...
public class MethodContext {
    ...
    public YumeCloudProtection obfuscator;
    ...
    public MethodContext(YumeCloudProtection obfuscator, MethodNode method, int methodIndex, ClassNode clazz,
                         int classIndex) {
